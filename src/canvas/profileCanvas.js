  ...
  return await runWithLimit(async () => {
    ...
    try {
      if (userProfile.activeBanners) {
        let activeBanners = typeof userProfile.activeBanners === "string" ? JSON.parse(userProfile.activeBanners) : userProfile.activeBanners;
    ...
    // Teks Username
    ctx.font = 'bold 36px "MontserratBold", "EmojiFont"';
    ...
    // Teks Level & Rank
    ctx.font = 'bold 24px "InterBold", "EmojiFont"';
    ...
    ctx.font = 'bold 14px "InterBold", "EmojiFont"';
    ctx.fillStyle = "#FFFFFF";
