...
class VoiceManager {
    static async speak(text, member) {
        if (!member || !member.voice.channel) {
            console.log('\x1b[41m\x1b[37m 🔊 TTS ERROR \x1b[0m \x1b[31mMember tidak berada di dalam Voice Channel.\x1b[0m');
            return;
        }
        ...
        try {
            ...
            if (client && client.poru && client.poru.players) {
                ...
                if (player && player.isPlaying) {
                    console.log('\x1b[43m\x1b[30m 🔊 TTS INFO \x1b[0m \x1b[33mVoice channel sedang digunakan oleh Poru untuk memutar musik. Membatalkan TTS agar tidak membajak koneksi.\x1b[0m');
                    return;
                }
            }
