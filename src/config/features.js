...
const FEATURES = Object.freeze({
  core: {
    ...
    category: "system",
    description:
      "Perintah dasar Naura seperti ping, info, about, help, dan bahasa.",
  ...
  automod: {
    ...
    category: "moderation",
    description:
      "Perlindungan otomatis untuk spam, invite, caps, mention berlebih, dan kata terlarang.",
  ...
  auditLog: {
    ...
    category: "moderation",
    description:
      "Pencatatan aktivitas server seperti pesan dihapus, channel berubah, role dibuat, dan kejadian penting lain.",
    enabledByDefault: false,
    setupKey: "auditLog",
    premium: false,
    healthCheck: true,
  ...
  ticket: {
    ...
    category: "support",
    description:
      "Sistem tiket dukungan server dengan channel kategori dan log.",
    enabledByDefault: false,
    setupKey: "ticket",
    premium: false,
    healthCheck: true,
  ...
  tempVoice: {
    ...
    category: "utility",
    description:
      "Room voice sementara yang dibuat otomatis saat user masuk trigger channel.",
    enabledByDefault: false,
    setupKey: "tempVoice",
    premium: false,
    healthCheck: true,
  ...
  music: {
    ...
    description:
      "Pemutar musik berbasis Lavalink dengan queue, kontrol tombol, filter, dan panel now playing.",
    enabledByDefault: true,
    setupKey: "music",
    premium: false,
    healthCheck: true,
  ...
  ai: {
    ...
    description:
      "Fitur percakapan dan bantuan cerdas Naura dengan provider AI berlapis.",
    enabledByDefault: false,
    setupKey: "ai",
    premium: false,
    healthCheck: true,
  ...
  survival: {
    ...
    category: "game",
    description:
      "Dunia RPG, ekonomi, quest, NPC, farming, crafting, dungeon, dan achievement.",
    enabledByDefault: false,
    setupKey: "survival",
    premium: false,
    healthCheck: false,
  ...
  dashboard: {
    ...
    category: "web",
    description:
      "Panel web untuk konfigurasi, statistik, OAuth2, dan kontrol server.",
    enabledByDefault: false,
    setupKey: "dashboard",
    premium: false,
    healthCheck: true,
  ...
  minecraft: {
    ...
    description:
      "Integrasi status server dan bridge Minecraft sesuai konfigurasi deployment.",
    enabledByDefault: false,
    setupKey: "minecraft",
    premium: false,
    healthCheck: true,
