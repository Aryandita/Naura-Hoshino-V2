...
const { banners, backgrounds, survivalBackgrounds } = require('./ui/assets');
...
module.exports = {
    ...
    getDungeonBackground() {
        return helpers.existingPath(this.survivalBackgrounds.tambang_malam) || DEFAULT_DUNGEON_BG;
    },

    createProgressBar(current, max, length = 10) {
        return helpers.progressBar(current, max, length, this.emojis.bar_filled, this.emojis.bar_empty);
    },
