...
class GuildWarEngine {
  ...
  static async declareChampion(winnerClanId, guildId) {
    ...
    if (redisManager.isReady) {
      ...
      logger.success(
        `[ClanWar] Clan ${winnerClanId} di Guild ${guildId} menang! Server Blessing 2x XP & Stamina aktif 24 jam.`,
      );
    }
