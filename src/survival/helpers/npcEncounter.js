...
const GREETINGS = {
  teman: {
    pagi: [
      "Eh, {nama}! Pagi-pagi sudah keliling, ya?",
      "Wah, {nama}. Baru bangun langsung jalan-jalan?",
    ],
    siang: [
      "{nama}! Panas-panas begini kok masih kuat jalan.",
      "Halo, {nama}. Mampir dulu, teduhan sini.",
    ],
    sore: [
      "Sore, {nama}. Enak ya udaranya sekarang.",
      "Eh {nama}, mau pulang atau baru mulai jalan?",
    ],
    malam: [
      "Malam, {nama}. Hati-hati kalau jalan sendirian.",
      "Masih di luar, {nama}? Jangan kemalaman, ya.",
    ],
  },
  romansa: {
    pagi: [
      "Selamat pagi, {nama}~ Kebetulan sekali kita bertemu.",
      "Eh, {nama}! Aku baru saja memikirkan kamu, lho.",
    ],
    siang: [
      "{nama}? Wah, senang bisa lihat kamu di jam sesibuk ini.",
      "Halo, {nama}. Sudah makan belum? Jangan dilewatkan, ya.",
    ],
    sore: [
      "Sore, {nama}. Mau jalan bareng sebentar?",
      "{nama}, langit sore ini bagus. Sayang kalau dilihat sendirian.",
    ],
    malam: [
      "Malam, {nama}. Hati-hati di jalan, nanti aku khawatir.",
      "Kamu masih di luar, {nama}? Setidaknya sekarang ada aku di sini.",
    ],
  },
};
...
function locationName(location) {
  ...
  return (
    LOCATION_NAMES[key] ||
    (key ? key.charAt(0).toUpperCase() + key.slice(1) : "Entah di mana")
  );
}
...
function npcsAt(location, hour) {
  ...
  return Object.values(npcs).filter(
    (npc) => npc && npc.id && effectiveLocation(npc, hour) === target,
  );
}
