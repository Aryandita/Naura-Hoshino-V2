...
const { FRAGMENT_PER_COIN } = require("../engines/currency");
...
const INVEST_ASSETS = {
  gold: {
    ...
    calcValue: (principal, days) =>
      days <= 0 ? principal : Math.floor(principal + principal * days * 0.012),
  },
  prop: {
    id: "prop",
