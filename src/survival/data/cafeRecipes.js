...
const CAFE_RECIPES = [
  {
    ...
    price: 250,
    requiredLevel: 1,
    description: "Kopi susu lembut dengan aroma kelopak sakura segar dari hutan Neo-Hoshino.",
    ingredients: [
  ...
  },
  {
    ...
    price: 300,
    requiredLevel: 2,
    description: "Boba kenyal berkilau neon dengan sirup blueberry dingin penyegar dahaga.",
    ingredients: [
  ...
  },
  {
    ...
    price: 400,
    requiredLevel: 4,
    description: "Es krim manis berlapis jeli bintang yang sangat digemari pet dan maskot.",
    ingredients: [
      { id: "berry", name: "Buah Berry", amount: 2 },
  ...
  },
  {
    ...
    price: 600,
    requiredLevel: 5,
    description: "Espresso pekat super kental yang memulihkan stamina secara instan.",
    ingredients: [
