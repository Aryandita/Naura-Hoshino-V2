...
const achievementsPool = [
  ...
  {
    id: "veteran_survivor",
    title: "Penyintas Veteran",
    description: "Mencapai Level Survival 25.",
    emoji: ui.getEmoji("medal") || "🎖️",
    color: "#86efac",
  },
  {
    id: "legendary_survivor",
    title: "Legenda Hidup",
    description: "Mencapai Level Survival 75.",
    emoji: ui.getEmoji("crown") || "👑",
    color: "#ffd700",
  },
  {
    id: "ascended_god",
    title: "Ascended God",
    description: "Mencapai puncak tertinggi Level Survival 100.",
    emoji: ui.getEmoji("sparkle") || "✨",
    color: "#f9a8d4",
  },
  {
    id: "month_survivor",
    title: "Satu Bulan Menembus Batas",
    description: "Bertahan hidup hingga hari ke-30 di dunia Naura.",
    emoji: ui.getEmoji("clock") || "⏰",
    color: "#60a5fa",
  },
  {
    id: "centennial_pioneer",
    title: "Pionir Seabad",
    description: "Bertahan hidup hingga hari ke-100 di dunia Naura.",
    emoji: ui.getEmoji("trophy") || "🏆",
    color: "#c084fc",
  },
  {
    id: "titan_strength",
    title: "Kekuatan Titan",
    description: "Mencapai 50 Strength murni dari petualangan.",
    emoji: ui.getEmoji("strength") || "💪",
    color: "#ef4444",
  },
  {
    id: "sage_wisdom",
    title: "Kebijaksanaan Mahaguru",
    description: "Mencapai 50 Intelligence melalui studi tekun.",
    emoji: ui.getEmoji("read") || "📖",
    color: "#a855f7",
  },
  {
    id: "wind_strider",
    title: "Penjelajah Angin",
    description: "Mencapai 50 Agility dengan kelincahan sempurna.",
    emoji: ui.getEmoji("chirping") || "🏃",
    color: "#06b6d4",
  },
  {
    id: "blessed_by_fortune",
    title: "Diberkahi Dewi Keberuntungan",
    description: "Mencapai 50 Luck dari berkah semesta.",
    emoji: ui.getEmoji("luck") || "🍀",
    color: "#10b981",
  },
  {
    id: "abyssal_champion",
    title: "Juara Samudera Gelap",
    description: "Menaklukkan Lantai 50 Infinite Dungeon.",
    emoji: ui.getEmoji("swords") || "⚔️",
    color: "#3b82f6",
  },
  {
    id: "dungeon_conqueror",
    title: "Penakluk Labirin Abadi",
    description: "Menaklukkan Lantai 100 Infinite Dungeon.",
    emoji: ui.getEmoji("skull") || "💀",
    color: "#dc2626",
  },
  {
    id: "arena_gladiator",
    title: "Gladiator Tak Terkalahkan",
    description: "Meraih 10 kemenangan di Ranked Duel Season.",
    emoji: ui.getEmoji("shield") || "🛡️",
    color: "#f59e0b",
  },
  {
    id: "master_barista",
    title: "Master Barista Cyber-Cafe",
    description: "Mengembangkan Kafe hingga Level 5.",
    emoji: ui.getEmoji("coffee") || "☕",
    color: "#78350f",
  },
  {
    id: "eternal_vow",
    title: "Janji Suci Abadi",
    description: "Menikah dengan penduduk kota/desa pilihan hatimu.",
    emoji: ui.getEmoji("wedding_ring") || "💍",
    color: "#ec4899",
  },
  {
    id: "gem_master",
    title: "Ahli Permata Kosmik",
    description: "Menyematkan socket permata kosmik pertama ke peralatanmu.",
    emoji: ui.getEmoji("gem") || "💎",
    color: "#8b5cf6",
  },
];
