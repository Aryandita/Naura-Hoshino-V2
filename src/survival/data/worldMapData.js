...
const REGIONS = {
  ...
  desa_khulkhas: {
    id: "desa_khulkhas",
    aliases: ["khulkhas", "desa_khulkhas", "gurun_khulkhas", "tanah_mistis"],
    name: "Desa Khul'Khas",
    title: "Wilayah Mistis Tersembunyi & Altar Relik Kuno",
    primaryCurrency: "Barter Artefak & NSF Langka",
    currencyCode: "starFragments",
    themeColor: "#F59E0B",
    description:
      "Kawasan rahasia yang tak tercantum di peta resmi. Memerlukan eksplorasi mandiri untuk menyingkap rahasia peradaban kuno dan mata air suci abadi.",
    pois: [
      {
        id: "altar_astral",
        name: "Altar Relik Astral (The Forgotten Shrine)",
        category: "mystery",
        ...
        emoji: "🔮",
        atmosphere:
          "Monolit batu hitam bertatahkan aksara bercahaya yang berdenyut selaras dengan detak jantung Astral Core.",
        facilities: ["resonansi_kristal", "meditasi_kosmik", "buka_segel_dimensi"],
      },
      {
        id: "bazaar_nomad",
        name: "Bazaar Nomad Gelap Khul'Khas",
        category: "commercial",
        residentNpcIds: ["syeikh_malik"],
        operatingHours: { start: 18, end: 6 }, // Pasar malam gurun
        coordinates: { x: 35, y: 55 },
        icon: "fa-solid fa-campground",
        emoji: "🎪",
        atmosphere:
          "Tenda-tenda kulit unta di bawah gemerlap bintang malam, menjual artefak terlarang tanpa pajak kota.",
        facilities: ["barter_artefak_kuno", "beli_peta_rahasia", "ramalan_nasib"],
      },
      {
        id: "mata_air_kabut",
        name: "Mata Air Kabut Abadi",
        category: "sanctuary",
        residentNpcIds: [],
        operatingHours: { start: 0, end: 24 },
        ...
        emoji: "💧",
        atmosphere:
          "Telaga air hangat beruap putih suci yang seketika menyembuhkan seluruh racun kutukan dan memulihkan vitalitas.",
        facilities: ["pembersihan_racun", "pemulihan_vitalitas_penuh", "berkah_alam"],
      },
      {
        id: "pondok_alkimia_khulkhas",
        name: "Pondok Pertapa Alkimia Khul'Khas",
        category: "workshop",
        residentNpcIds: ["syeikh_malik"],
        operatingHours: { start: 6, end: 22 },
        ...
        emoji: "🧪",
        atmosphere:
          "Gubuk terpencil berjejer botol ramuan berpendar yang menyimpan resep transendensi kuno.",
        facilities: ["sintesis_elixir_transendensi", "racik_bunga_mawar_kristal"],
      },
    ],
  },
