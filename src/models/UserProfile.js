...
const UserProfile = sequelize.define('UserProfile', {
    ...
    economy_deposit: { type: DataTypes.JSON, defaultValue: { amount: 0, unlockDate: null, interestRate: 0, termName: null } },
    economy_investments: {
        type: DataTypes.JSON,
        defaultValue: {
            gold: 0, goldBuyDay: 0,
            prop: 0, propBuyDay: 0,
            tech: 0, techBuyDay: 0,
            energy: 0, energyBuyDay: 0,
            capital: 0, capitalBuyDay: 0
        }
    },
