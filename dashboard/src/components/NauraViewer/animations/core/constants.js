...
export const DEFAULT_REST_BONES = {
  ...
  leftUpperArm: [-0.11, 0, 0],
  rightUpperArm: [0.11, 0, 0],
  leftLowerArm: [-0.03, 0, 0.04],
  rightLowerArm: [0.03, 0, 0.04],
  leftHand: [-0.02, 0, 0.01],
  rightHand: [0.02, 0, 0.01],
  leftUpLeg: [0, 0, 0],
  leftLeg: [0, 0, 0],
  leftFoot: [0, 0, 0],
  rightUpLeg: [0, 0, 0],
...
export const GLB_BONE_PATTERNS = {
  ...
  rightLowerArm:
    /^(right_?forearm|r_?forearm|right_?lower_?arm|forearm[._]r)$/i,
  ...
  // VRM 1.0
  rightUpperLeg:
    /^(right_?upper_?leg|r_?upper_?leg|right_?thigh|r_?thigh|rightUpperLeg)$/i,
  rightLowerLeg:
    /^(right_?lower_?leg|r_?lower_?leg|right_?calf|r_?calf|right_?shin|rightLowerLeg)$/i,
  rightFoot: /^(right_?foot|r_?foot|foot[._]r)$/i,
  leftUpperLeg:
    /^(left_?upper_?leg|l_?upper_?leg|left_?thigh|l_?thigh|leftUpperLeg)$/i,
  leftLowerLeg:
    /^(left_?lower_?leg|l_?lower_?leg|left_?calf|l_?calf|left_?shin|leftLowerLeg)$/i,
