...
export const GLB_BONE_PATTERNS = {
    ...
    rightUpLeg: /^(right_?upleg|r_?upleg|right_?thigh|r_?thigh)$/i,
    rightLeg: /^(right_?leg|r_?leg|right_?calf|r_?calf)$/i,
    rightFoot: /^(right_?foot|r_?foot|foot[._]r)$/i,
    leftUpLeg: /^(left_?upleg|l_?upleg|left_?thigh|l_?thigh)$/i,
    leftLeg: /^(left_?leg|l_?leg|left_?calf|l_?calf)$/i,
