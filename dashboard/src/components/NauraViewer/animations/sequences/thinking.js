...
export const thinkingSequence = {
    ...
    "bones": {
        ...
        "rightUpperArm": [
            ...
            { "t": 0.50, "val": [0.23, -0.43, 2.48] },
            { "t": 0.65, "val": [0.24, -0.41, 2.46] },
            { "t": 0.78, "val": [0.23, -0.43, 2.48] },
            { "t": 0.88, "val": [0.10, -0.18, 1.0] },
            { "t": 1, "val": [0.11, 0, 0.01] }
        ],
        "rightLowerArm": [
            { "t": 0, "val": [0.03, 0, 0.04] },
            { "t": 0.12, "val": [-0.10, -0.30, 0.6] },
            { "t": 0.28, "val": [-0.28, -0.82, 1.62] },
            { "t": 0.38, "val": [-0.26, -0.80, 1.60] },
            { "t": 0.50, "val": [-0.28, -0.82, 1.62] },
            { "t": 0.65, "val": [-0.26, -0.80, 1.60] },
        ...
        "rightHand": [
            { "t": 0, "val": [0.02, 0, 0.01] },
            { "t": 0.12, "val": [0.05, 0, 0] },
            { "t": 0.28, "val": [0.20, 0.05, 0.02] },
            { "t": 0.50, "val": [0.22, 0.06, 0.02] },
            { "t": 0.78, "val": [0.20, 0.05, 0.02] },
            { "t": 0.88, "val": [0.05, 0, 0] },
            { "t": 1, "val": [0.02, 0, 0.01] }
        ],
        "leftUpperArm": [
