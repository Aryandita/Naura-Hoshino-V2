...
export const sleepySequence = {
  ...
  bones: {
    ...
    rightUpperArm: [
      ...
      { t: 0.5, val: [0.24, -0.35, 2.5] },
      { t: 0.62, val: [0.23, -0.36, 2.48] },
      { t: 0.72, val: [0.22, -0.38, 2.45] },
      { t: 0.85, val: [0.1, -0.16, 1.1] },
      { t: 1, val: [0.11, 0, 0.01] },
    ],
    rightLowerArm: [
      { t: 0, val: [0.03, 0, 0.04] },
      { t: 0.15, val: [-0.1, -0.35, 0.7] },
      { t: 0.32, val: [-0.2, -0.9, 1.8] },
      { t: 0.38, val: [-0.18, -0.88, 1.85] },
      { t: 0.5, val: [-0.16, -0.85, 1.88] },
      { t: 0.62, val: [-0.18, -0.88, 1.85] },
      { t: 0.72, val: [-0.2, -0.9, 1.8] },
      { t: 0.85, val: [-0.1, -0.35, 0.7] },
      { t: 1, val: [0.03, 0, 0.04] },
    ],
    rightHand: [
      { t: 0, val: [0.02, 0, 0.01] },
      { t: 0.15, val: [0.05, 0, 0] },
      { t: 0.32, val: [0.2, 0.05, 0] },
      { t: 0.5, val: [0.22, 0.05, 0] },
      { t: 0.72, val: [0.2, 0.05, 0] },
      { t: 0.85, val: [0.05, 0, 0] },
      { t: 1, val: [0.02, 0, 0.01] },
    ],
    leftUpperArm: [
