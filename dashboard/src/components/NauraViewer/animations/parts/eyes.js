...
export class EyeController {
    constructor(options = {}) {
        ...
        this.target = new THREE.Vector3(0, 0.22, 1.20);
    ...
    update(delta, elapsed, context = {}) {
        try {
            ...
            this.target.set(gazeX * 0.35, 0.22 + gazeY * 0.25, 1.20);
            ...
            console.warn("[NauraAnimation:Eyes] Error updating eye gaze:", err.message);
        }
    }
