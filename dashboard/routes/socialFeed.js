...
const DEFAULT_POSTS = [
  {
    ...
    content: "Pagi semuanya! 🌸 Hari ini cuaca di Frostsnow Kingdom cerah banget. Jangan lupa selesaikan daily quest dan beri makan pet kalian ya!",
    likes: 42,
  ...
  },
  {
    ...
    content: "Tadi malam ada yang nekat menantang Abyssal Leviathan sendirian di World Boss Raid... untung diselamatkan pet Bahamut temannya! Hebat banget kerjasamanya ✨",
    likes: 88,
  ...
  },
  {
    ...
    content: "Selamat untuk server pemenang Clan War minggu ini! Nikmati 2x XP Boost & 2x Stamina Regeneration untuk 24 jam ke depan ya! 🏆",
    likes: 125,
...
module.exports = (client) => {
  ...
  router.get("/api/feed", async (req, res) => {
    try {
      ...
      if (redisManager.isReady) {
        await redisManager.setCache(FEED_CACHE_KEY, JSON.stringify(DEFAULT_POSTS), 600);
      }
