...
function mannersOf(profile, levelRow) {
  if (
    profile &&
    profile.mannersPoint !== undefined &&
    profile.mannersPoint !== null
  ) {
    return profile.mannersPoint;
  }
  if (
    levelRow &&
    levelRow.mannersPoint !== undefined &&
    levelRow.mannersPoint !== null
  ) {
...
module.exports = {
  ...
  async execute(interaction) {
    ...
    let profile;
    try {
      levelRow = await UserLeveling.findOne({
    ...
    const attachment = new AttachmentBuilder(card.buffer, {
