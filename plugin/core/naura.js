  ...
  async execute(interaction) {
    ...
    if (subcommand === "about") {
      ...
      const row1 = new ActionRowBuilder().addComponents(
        new ButtonBuilder()
          .setCustomId("nplay_koin")
          .setEmoji(e("coin", "\uD83E\uDE99"))
          .setLabel("Tebak Koin")
          .setStyle(ButtonStyle.Primary),
        new ButtonBuilder()
          .setCustomId("nplay_angka")
          .setEmoji(e("numbers", "\uD83D\uDD22"))
          .setLabel("Tebak Angka")
          .setStyle(ButtonStyle.Primary),
        new ButtonBuilder()
          .setCustomId("nplay_warna")
          .setEmoji(e("palette", "\uD83C\uDFA8"))
          .setLabel("Tebak Warna")
          .setStyle(ButtonStyle.Primary),
        new ButtonBuilder()
          .setCustomId("nplay_gelas")
          .setEmoji(e("glass_of_milk", "\uD83E\uDD5B"))
          .setLabel("Pilih Gelas")
          .setStyle(ButtonStyle.Primary),
      );

      const row2 = new ActionRowBuilder().addComponents(
        new ButtonBuilder()
          .setCustomId("nplay_suit")
          .setEmoji(e("fist", "\u270A"))
          .setLabel("Suit")
          .setStyle(ButtonStyle.Primary),
        new ButtonBuilder()
          .setCustomId("nplay_dadu")
          .setEmoji(e("game_die", "\uD83C\uDFB2"))
          .setLabel("Lempar Dadu")
          .setStyle(ButtonStyle.Primary),
        new ButtonBuilder()
          .setCustomId("nplay_balapan")
          .setEmoji(e("sport_utility_vehicle", "\uD83C\uDFCE\uFE0F"))
          .setLabel("Balapan")
          .setStyle(ButtonStyle.Primary),
        new ButtonBuilder()
          .setCustomId("nplay_roulette")
          .setEmoji(e("gun", "\uD83D\uDD2B"))
          .setLabel("Roulette")
          .setStyle(ButtonStyle.Primary),
      );
      ...
      const row3 = new ActionRowBuilder().addComponents(
        new ButtonBuilder()
          .setCustomId("nplay_rps")
          .setEmoji(e("scissors", "\u2702\uFE0F"))
          .setLabel("Batu Gunting Kertas")
          .setStyle(ButtonStyle.Secondary),
        new ButtonBuilder()
          .setCustomId("nplay_ttt")
          .setEmoji(e("red_circle", "\uD83D\uDD34"))
          .setLabel("Tic-Tac-Toe")
          .setStyle(ButtonStyle.Secondary),
        new ButtonBuilder()
          .setCustomId("nplay_wordle")
          .setEmoji(e("green_square", "\uD83D\uDFE9"))
          .setLabel("Wordle")
          .setStyle(ButtonStyle.Secondary),
        new ButtonBuilder()
          .setCustomId("nplay_akinator")
          .setEmoji(e("genie", "\uD83E\uDDDE"))
          .setLabel("Akinator")
          .setStyle(ButtonStyle.Secondary),
      );
      ...
      collector.on("collect", async (i) => {
        ...
        const hint = {
          nplay_rps:
            "Buat main Batu Gunting Kertas sama Naura, pakai `/minigame rps taruhan:<jumlah>` yaa!",
          nplay_ttt:
            "Tic-Tac-Toe ada di `/minigame tictactoe taruhan:<jumlah>`. Naura tunggu di sana!",
          nplay_wordle:
            "Mau nebak kata? Coba `/minigame wordle taruhan:<jumlah>` yaa~",
          nplay_akinator:
            "Akinator ada di `/minigame akinator`. Siap-siap ditebak pikirannya, hihi!",
        }[game];

        if (hint) {
          return i.reply({
            content: `${face("info", "\uD83D\uDCA1")} ${hint}`,
            flags: MessageFlags.Ephemeral,
          });
        }
        ...
        if (game === "nplay_koin") {
          return i.update(
            buildContainerV2({
              ...
              description:
                "Naura udah lempar koinnya nih! Menurut kamu, muncul Kepala atau Ekor?",
              expression: "thinking",
              buttonsRow: new ActionRowBuilder().addComponents(
                new ButtonBuilder()
                  .setCustomId("koin_kepala")
                  .setLabel("Kepala")
                  .setStyle(ButtonStyle.Success),
                new ButtonBuilder()
                  .setCustomId("koin_ekor")
                  .setLabel("Ekor")
                  .setStyle(ButtonStyle.Primary),
              ),
              footerText: ui.getFooter("core"),
        ...
        if (game === "nplay_angka") {
          return i.update(
            buildContainerV2({
              ...
              description:
                "Naura lagi mikirin satu angka dari 1 sampai 10. Coba tebak yang mana!",
              expression: "thinking",
              buttonsRow: [
                new ActionRowBuilder().addComponents(
                  [1, 2, 3, 4, 5].map((n) =>
                    new ButtonBuilder()
                      .setCustomId(`angka_${n}`)
                      .setLabel(`${n}`)
                      .setStyle(ButtonStyle.Secondary),
                  ),
                ),
        ...
        if (game === "nplay_suit") {
          ...
          return i.update(
            buildContainerV2({
              ...
              buttonsRow: new ActionRowBuilder().addComponents(
                new ButtonBuilder()
                  .setCustomId("suit_gajah")
                  .setEmoji(eElephant)
                  .setLabel("Gajah")
                  .setStyle(ButtonStyle.Secondary),
                new ButtonBuilder()
                  .setCustomId("suit_orang")
                  .setEmoji(ePerson)
                  .setLabel("Orang")
                  .setStyle(ButtonStyle.Secondary),
                new ButtonBuilder()
                  .setCustomId("suit_semut")
                  .setEmoji(eAnt)
                  .setLabel("Semut")
                  .setStyle(ButtonStyle.Secondary),
              ),
        ...
        if (game === "nplay_warna") {
          return i.update(
            buildContainerV2({
              ...
              description:
                "Naura lagi mikirin satu warna di bawah ini. Kira-kira yang mana yaa?",
              expression: "thinking",
              buttonsRow: new ActionRowBuilder().addComponents(
                new ButtonBuilder()
                  .setCustomId("warna_merah")
                  .setEmoji(e("red_circle", "\uD83D\uDD34"))
                  .setLabel("Merah")
                  .setStyle(ButtonStyle.Danger),
                new ButtonBuilder()
                  .setCustomId("warna_biru")
                  .setEmoji(e("blue_circle", "\uD83D\uDD35"))
                  .setLabel("Biru")
                  .setStyle(ButtonStyle.Primary),
                new ButtonBuilder()
                  .setCustomId("warna_hijau")
                  .setEmoji(e("green_circle", "\uD83D\uDFE2"))
                  .setLabel("Hijau")
                  .setStyle(ButtonStyle.Success),
                new ButtonBuilder()
                  .setCustomId("warna_kuning")
                  .setEmoji(e("yellow_circle", "\uD83D\uDFE1"))
                  .setLabel("Kuning")
                  .setStyle(ButtonStyle.Secondary),
              ),
              footerText: ui.getFooter("core"),
        ...
        if (game === "nplay_gelas") {
          ...
          return i.update(
            buildContainerV2({
              ...
              description:
                "Naura udah sembunyiin bola kecil di bawah salah satu dari tiga gelas ini. Coba tebak yang mana!",
              expression: "thinking",
              buttonsRow: new ActionRowBuilder().addComponents(
                new ButtonBuilder()
                  .setCustomId("gelas_1")
        ...
        if (game === "nplay_dadu") {
          ...
          return i.update(
            buildContainerV2({
              ...
              description:
                "Ayo adu lempar dadu! Siapa yang dapat angka paling besar, dia yang menang. Naura udah siap nih!",
              expression: "happy",
              buttonsRow: new ActionRowBuilder().addComponents(
                new ButtonBuilder()
                  .setCustomId("dadu_lempar")
                  .setEmoji(eDie)
        ...
        if (game === "nplay_balapan") {
          ...
          return i.update(
            buildContainerV2({
              ...
              description:
                "Ada tiga mobil yang mau balapan: Merah, Biru, dan Hijau. Kamu mau jagoin yang mana?",
              expression: "happy",
              buttonsRow: new ActionRowBuilder().addComponents(
                new ButtonBuilder()
                  .setCustomId("balapan_merah")
                  .setEmoji(eCar)
                  .setLabel("Merah")
                  .setStyle(ButtonStyle.Danger),
                new ButtonBuilder()
                  .setCustomId("balapan_biru")
                  .setEmoji(eCar)
                  .setLabel("Biru")
                  .setStyle(ButtonStyle.Primary),
                new ButtonBuilder()
                  .setCustomId("balapan_hijau")
                  .setEmoji(e("pickup_truck", "\uD83D\uDEFB"))
                  .setLabel("Hijau")
                  .setStyle(ButtonStyle.Success),
              ),
              footerText: ui.getFooter("core"),
        ...
        if (game === "nplay_roulette") {
          ...
          return i.update(
            buildContainerV2({
              ...
              description:
                "Cuma ada satu peluru di dalam enam lubang pistol mainan ini. Berani tarik pelatuknya? Naura deg-degan nih...",
              expression: "shocked",
              buttonsRow: new ActionRowBuilder().addComponents(
                new ButtonBuilder()
                  .setCustomId("roulette_tarik")
                  .setEmoji(eGun)
        ...
        if (game.startsWith("suit_")) {
          ...
          if (draw) result = "Seri! Hihi, pikiran kita sehati yaa~";
            ...
            result =
              "Kali ini Naura yang menang! Jangan cemberut yaa, coba lagi yuk~";

          return i.update(
            buildContainerV2({
              accentColorHex: draw
                ? ui.getColor("warning")
                : ui.getColor(win ? "success" : "error"),
        ...
        if (game === "dadu_lempar") {
          ...
          let result;
          if (draw)
            result = "Eh seri! Dadu kita sama angkanya, kompak banget yaa~";
          else if (win)
            result =
              "Wahh kamu menang! Lemparan kamu lebih tinggi dari punya Naura!";
          else
            result =
              "Kali ini lemparan Naura lebih besar. Tapi kamu hebat kok, ayo sekali lagi!";
