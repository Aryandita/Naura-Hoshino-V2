...
module.exports = async function transcribe(interaction) {
    ...
    const mimeOk = attachment.contentType
    ...
    await interaction.editReply(buildLoadingContainerV2({
        ...
        description: 'Sabar sebentar yaa, Naura sedang menyimak berkasmu baik-baik supaya tidak ada kata yang terlewat.',
        footerText: ui.getFooter('core')
    }));
    ...
    try {
        ...
        for (let i = 0; i < chunks.length; i++) {
            ...
            const payload = buildContainerV2({
                ...
                title: isFirst ? `${e('cheers', '\uD83C\uDFA7')} Ini hasil dengarnya!` : undefined,
                iconURL: isFirst ? interaction.client.user.displayAvatarURL() : undefined,
