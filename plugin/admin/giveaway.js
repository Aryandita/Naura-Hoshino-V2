  ...
  data: new SlashCommandBuilder()
      ...
      sub
        ...
        .addIntegerOption((opt) =>
          opt
            ...
            .setDescription(
              "Umur akun Discord minimum dalam hari (anti-bot, opsional)",
            )
            .setRequired(false)
            .setMinValue(1),
        )
    ...
    .addSubcommand((sub) =>
      sub
        .setName("list")
        .setDescription(
          "Lihat daftar giveaway yang sedang aktif di server ini",
        ),
    ),
  ...
  async execute(interaction) {
    ...
    if (subCmd === "start") {
      ...
      const hasRequirements =
        reqRole || minLevel || minUmurAkun || harusBooster;
        ...
        return interaction.reply(
          ephemeral(
            buildErrorContainerV2({
              ...
              description:
                "Naura tidak menemukan giveaway itu, atau giveawaynya sudah berakhir.",
              footerText: ui.getFooter("core"),
            }),
          ),
        );
      ...
      await interaction.reply(
        ephemeral(
          buildContainerV2({
            ...
            expression: "loading",
            description:
              "Naura sedang mengundi pemenangnya, tunggu sebentar ya!",
            footerText: ui.getFooter("core"),
          }),
        ),
      );
        ...
        await interaction
          .editReply(
            buildErrorContainerV2({
              ...
              description:
                "Naura gagal mengakhiri giveaway itu. Coba periksa apakah pesannya masih ada ya.",
              footerText: ui.getFooter("core"),
            }),
          )
          .catch(() => {});
    ...
    if (subCmd === "reroll") {
      ...
      const participants = Array.isArray(gwData.participants)
        ? gwData.participants
        : [];
        ...
        return interaction.reply(
          ephemeral(
            buildErrorContainerV2({
              ...
              description:
                "Giveaway ini tidak memiliki peserta, sehingga tidak bisa di-reroll.",
              footerText: ui.getFooter("core"),
            }),
          ),
        );
      ...
      await interaction.reply(
        ephemeral(
          buildContainerV2({
            ...
            description:
              "Naura mengundi ulang pemenang baru dari peserta yang sama!",
            footerText: ui.getFooter("core"),
          }),
        ),
      );
    ...
    if (subCmd === "list") {
      ...
      const lines = activeGiveaways.map((gw, i) => {
        ...
        const participantCount = Array.isArray(gw.participants)
