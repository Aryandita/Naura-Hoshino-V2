...
// Semua ID di bawah ini sudah dicocokkan dengan plugin/survival/items_static.js.
// Kartu sambutan dibangun dari daftar yang sama, jadi teks dan isi tas tidak
// akan pernah lagi berbeda.
const STARTER_KIT = [
    ...
    { id: 'steel_pickaxe', name: 'Beliung Baja', amount: 1, icon: '\u26CF\uFE0F', note: 'Buat menambang di gua' },
    { id: 'iron_sword', name: 'Pedang Besi (Lv. 1)', amount: 1, icon: '\uD83D\uDDE1\uFE0F', note: 'Senjata pertamamu di Dungeon' },
    ...
    async execute(interaction) {
        ...
        const payload = buildContainerV2({
            ...
            description: `Halo **${user.displayName}**! Naura senang banget kamu ikut bertualang di sini.\n\n`
                + `Naura sudah siapkan bekal lengkap buat kamu, semoga membantu di hari pertama:\n\n${daftarBarang}\n\n`
