...
const DUNGEON_ITEMS = [
    {
        id: DUNGEON_PASS_ID,
        name: 'Dungeon Pass',
        description: 'Tiket sekali pakai untuk membuka pintu batu Infinite Dungeon di gua tambang. Naura titip pesan: jangan lupa bawa obat, ya!',
        price: 1500,
        sellPrice: 300,
        category: 'pass',
        rarity: 'Biasa'
    },
    {
        ...
        description: 'Tiket segel merah dari kota. Musuh di dalam jadi dua kali lebih tangguh, tapi jarahan dan hadiahnya juga dua kali lipat. Naura khawatir, tapi percaya kamu kuat!',
        price: 400,
        sellPrice: 0,
        category: 'pass',
        rarity: 'Langka'
