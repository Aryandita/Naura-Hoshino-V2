...
const BLUEPRINTS = {
    wooden_axe: {
        ...
        req: [{ id: 'wood', amount: 3 }, { id: 'fiber', amount: 1 }],
        emojiKey: 'axe',
        emojiFallback: '\ud83e\ude93'
    },
    wooden_pickaxe: {
        ...
        req: [{ id: 'wood', amount: 3 }, { id: 'stone', amount: 2 }],
        emojiKey: 'pickaxe',
        emojiFallback: '\u26cf\ufe0f'
    },
    wooden_sword: {
        ...
        req: [{ id: 'wood', amount: 2 }, { id: 'fiber', amount: 2 }],
        emojiKey: 'sword',
        emojiFallback: '\ud83d\udde1\ufe0f'
    },
    bamboo_rod: {
        ...
        req: [{ id: 'wood', amount: 2 }, { id: 'fiber', amount: 3 }],
    ...
    worm_bait: {
        ...
        req: [{ id: 'fiber', amount: 2 }, { id: 'trash', amount: 1 }],
        amount: 3,
        emojiKey: 'worm',
        emojiFallback: '\ud83e\udab1'
    },
    heist_mask: {
        ...
        req: [{ id: 'trash', amount: 5 }, { id: 'fiber', amount: 2 }],
        emojiKey: 'mask',
        emojiFallback: '\ud83c\udfad'
    },
    c4_bomb: {
        ...
        req: [{ id: 'iron_ingot', amount: 2 }, { id: 'charcoal', amount: 3 }, { id: 'fiber', amount: 2 }],
        emojiKey: 'bomb',
        emojiFallback: '\ud83d\udca3'
    }
};
...
const DEFAULT_UNLOCKED = ['wooden_axe', 'wooden_pickaxe', 'wooden_sword', 'bamboo_rod', 'worm_bait', 'heist_mask'];
...
function listAvailable(unlocked = []) {
    return Object.values(BLUEPRINTS).filter(bp => DEFAULT_UNLOCKED.includes(bp.id) || unlocked.includes(bp.id));
}
