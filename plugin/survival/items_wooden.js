...
const woodenTools = [
    {
        ...
        description: 'Beliung kayu sederhana. Cukup buat menambang batu di gua dangkal.',
        price: 700,
        sellPrice: 150,
        category: 'tools',
        upgrade_level: 1,
    ...
    },
    {
        ...
        description: 'Pedang latihan dari kayu keras. Ringan, tapi lumayan buat melawan Slime.',
        price: 900,
        sellPrice: 200,
        category: 'tools',
        upgrade_level: 1,
