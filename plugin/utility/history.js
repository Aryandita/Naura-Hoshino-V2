...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("history")
    .setDescription("📜 Lihat 10 riwayat aktivitas & transaksi akun terakhir"),
    ...
    try {
      ...
      if (!logs || logs.length === 0) {
        const emptyPayload = buildContainerV2({
          ...
          description: [
            ...
            "",
            "-# 💡 *Catatan audit akan otomatis terbentuk saat kamu melakukan aktivitas ekonomi, transfer saldo, atau minigame.*",
          ].join("\n"),
      ...
      const payload = buildContainerV2({
        ...
        description: [
          ...
          logLines.join("\n"),
          "",
          "-# 🔒 *Semua transaksi dan perintah dicatat permanen demi keamanan dan transparansi.*",
        ].join("\n"),
        footerText: ui.getFooter("core"),
      });
      ...
      const errPayload = buildErrorContainerV2({
        title: "Gagal Membaca Riwayat",
        errorMessage:
          "Terjadi kendala saat membaca data dari MongoDB. Mohon coba beberapa saat lagi ya!",
      });
