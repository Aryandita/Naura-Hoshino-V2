...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption(opt => opt.setName('package').setDescription('Nama package NPM (contoh: discord.js)').setRequired(true)),
        ...
        try {
            ...
            const payload = buildContainerV2({
                ...
                fields: [
                    ...
                    { name: '📄 Lisensi', value: `\`${latestData.license || 'Tidak diketahui'}\`` },
                    { name: '👤 Author', value: data.author ? (data.author.name || JSON.stringify(data.author)) : 'Tidak diketahui' }
                ],
                footerText: ui.getFooter('utility')
            });
