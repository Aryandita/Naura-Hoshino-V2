...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const payload = buildContainerV2({
      ...
      description:
        "Centang notifikasi yang ingin kamu terima melalui Direct Message. Custom Reminder selalu aktif dan akan dikirim secara otomatis ke DM kamu jika disetel menggunakan `/remind`.",
      expression: "Happy",
