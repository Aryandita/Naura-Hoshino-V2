...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption(opt => opt.setName('url').setDescription('URL panjang yang ingin dipendekkan (harus diawali http/https)').setRequired(true)),
        ...
        try {
            ...
            if (data.errorcode) {
                const errPayload = buildErrorContainerV2({
                    ...
                    description: data.errormessage || 'Terjadi kesalahan saat memendekkan URL.',
                    footerText: ui.getFooter('utility')
                });
                return interaction.editReply(errPayload);
            }
            ...
            const errPayload = buildErrorContainerV2({
                ...
                description: 'Terjadi kesalahan internal saat menghubungi layanan pemendek URL.',
                footerText: ui.getFooter('utility')
            });
