    ...
    async cleanup() {
        for (const f of this.files) {
            try {
                ...
                logger.error(`[CleanupManager] Gagal hapus berkas sementara: ${f} - ${e.message}`);
            }
        }
        this.files.clear();
    }
...
const BRANDING_HOST_PATTERN = /(snapsave|savefrom|ssstik|sfrom|snapinsta|publer|agatz|igram|fastdl|downloader)/i;
