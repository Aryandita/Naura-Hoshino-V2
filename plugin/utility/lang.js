...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            await cacheManager.updateUserProfile(interaction.user.id, { language: selectedLang });

            const translatedMsg = await LanguageManager.translate(interaction.user.id, 'lang_success');
            ...
            ui.sendError(interaction, 'Gagal mengubah pengaturan bahasa / Failed to change language settings.', true);
        }
    }
};
