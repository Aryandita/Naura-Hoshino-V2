...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption(opt => opt.setName('username').setDescription('Username GitHub').setRequired(true)),
    ...
    async execute(interaction) {
        ...
        try {
            ...
            const payload = buildContainerV2({
                ...
                iconURL: data.avatar_url || 'https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png',
                description: `${data.bio || 'Tidak ada bio.'}\n\n🔗 [Lihat Profil GitHub](${data.html_url})`,
                fields: [
                    { name: '👥 Followers / Following', value: `${data.followers} / ${data.following}` },
