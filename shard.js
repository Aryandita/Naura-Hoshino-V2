...
manager.spawn({ amount: manager.totalShards, delay: 5500, timeout: 60000 }).catch(error => {
...
async function shutdownManager() {
    ...
    setTimeout(() => {
        console.log('\x1b[42m\x1b[30m ✨ MANAGER \x1b[0m \x1b[32mSemua proses shard telah aman. Exiting...\x1b[0m');
        process.exit(0);
    }, 5000);
}
